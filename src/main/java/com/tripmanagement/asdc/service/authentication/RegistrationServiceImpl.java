...
/*Service class for Registration contains logic related to registration of a user. This class interacts with the registration DAO for database operations*/
@Service
