...
import com.tripmanagement.asdc.stringsAndConstants.service.ServiceImplConstants;
...
public class CustomerServiceImpl implements CustomerService {
	...
	public boolean saveCustomer(User user) {
		...
		customer.setAvailable_credits(ServiceImplConstants.INITIAL_CREDITS_CUSTOMER);
